...
const FolderIcon = () => (
  <svg className="w-4 h-4 text-[#007AFF] fill-current opacity-90" viewBox="0 0 20 20">
...
const AirDropIcon = () => (
  <svg className="w-4 h-4 text-[#007AFF]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M8 12l4 4 4-4M12 8v8" />
  </svg>
)
...
const DiskIcon = () => (
  <svg className="w-4 h-4 text-neutral-500 dark:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
